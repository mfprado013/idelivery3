...
export default function App() {
  ...
  return (
    <>
      <Swiper slidesPerView={4} spaceBetween={20} className="lg:hidden w-full h-full mt-20 mt-4">
        ...
        <SwiperSlide className="pb-32 sm:ml-0 ml-6"><Link href="#">
          <a className="absolute bg-white border-solid border-2 border-black rounded-lg w-32 h-32">
        ...
        <SwiperSlide className="sm:ml-0 ml-6"><Link href="#">
          <a className="absolute bg-white border-solid border-2 border-black rounded-lg w-32 h-32">
        ...
        <SwiperSlide className="sm:ml-0 ml-6">
          <Link href="#">
            <a className="absolute bg-white border-solid border-2 border-black rounded-lg w-32 h-32">
